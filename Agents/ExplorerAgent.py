...
class ExplorerAgent(Agent):
    ...
    def act(self) -> Action:
        if not self.learn_mode:
            ...
            return ChickenCoop.get_action((0,2), self.position) # TODO - HARDCODED - neste momento esta a correr o que foi gerado no genotype com random actions (isto é pra mudar)
